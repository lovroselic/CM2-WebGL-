...
const MONSTER_LAYOUT = {
    ...
    3: {
        ...
        corridor: {
            N: 25,
            monster: { GhostFaceGreen: 1, SpiderGreen: 1, Astro: 1, MissWhite: 1, Viking: 2, AstroRed: 2, MissGreen: 3 }
        },
        common: {
            N: 2,
            monster: { GhostFaceGreen: 1, SpiderGreen: 1, Astro: 1, MissWhite: 1, Viking: 2, AstroRed: 2, MissGreen: 3 }
        ...
        Gold: {
            N: 2,
            monster: { Viking: 2, AstroRed: 2, MissGreen: 2, Hulk: 3 },
            boss: { Hulk_BossL2: 1 }
        },
        Silver: {
            N: 2,
            monster: { Viking: 2, AstroRed: 2, MissGreen: 2, Hulk: 2 },
            boss: { Viking: 1 },
        },
        Red: {
            N: 2,
            monster: { Viking: 2, AstroRed: 2, MissGreen: 3, Hulk: 1 },
            boss: { Viking: 1 },
        },
        firstKey: {
            N: 2,
            monster: { GhostFaceGreen: 1, Astro: 1, Viking: 2, AstroRed: 2, MissGreen: 3 },
            boss: { Astro: 1 },
        },
        temple: {
            N: 1,
